...
import com.hoodinahi.store.orders.OrderItems;
...
public class StripePaymentGateway implements PaymentGateway {
    ...
    @Override
    public CheckoutSessoion createCheckoutSession(Order order) {
        ...
        try {
            ...
            return new CheckoutSessoion(session.getUrl());
    ...
    private LineItem createLineItem(OrderItems item) {
    ...
    @Override
    public Optional<PaymentResult> pareWebhookRequest(WebhookRequest request) {
        try {
    ...
    private Long extractOrderId(Event event){
        ...
        var stripeObject = event.getDataObjectDeserializer().getObject().orElseThrow(() -> 
            new PaymentException("Failed to deserialize Stripe object, Check the SDK and the API version"));
